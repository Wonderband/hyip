...
const openModal = (num) => {
  ...
  switch (num) {
    case 0:
      ...
      myAnswer = "Я хлопець, і мені точно більше 18 років))";
      break;
    case 1:
      requirement = "Знання HTML, CSS";
      myAnswer =
        "Я добре знаю HTML5, CSS, SASS, BEM та використовую ці знання більше 5 років.<br/> Також знайомий з CSS-анімацією, адаптивною, респонсивною версткою та графікою";
      break;
    case 2:
    ...
    case 4:
      ...
      myAnswer =
        "Впевнений юзер Photoshop, Illustrator, Figma. <br/> Працюю також у відео та музичних редакторах (Filmora, Cubase)";
      break;
    case 5:
      requirement = "Потрібна креативність";
      myAnswer =
        "Креативності в моїй біографії аж забагато. Тривалий час працював копірайтером, контент-менеджером, креативним-директором. Більше подробиць - у резюме.<br/> Відзначу, що для мене креатив - це створення ідеї, а не картинки.<br/> Я - не дизайнер, не стиліст і ніколи не любив малювати))";
      break;
    case 6:
      requirement = "Вміння працювати в команді";
      myAnswer =
        "Всі кажуть, зі мною комфортно працювати. Я не педант, але завжди мислю раціонально. Уважно читаю ТЗ, витримую дедлайни, поважаю конструктивну критику. Вмію йти за лідером, можу вести підлеглих за собою. <br/>Я завжди на зв'язку та готовий швидко підключитися до нової задачі. Швидко начаюся новому.";
      break;
    case 7:
      requirement =
        "Не обов’язково, але буде плюсом будь-які знання на тему криптовалюти/інвестиційних проєктів";
      myAnswer =
        "Колись грався з криптою, мав біткойни, але всі продав)) <br/>Знаю основні біржі, маю уявлення про блокчейн, регулярно проглядаю новини на фінансову тематику. <br/>Інвестував, і неодноразово, свої кошти у банківські та небанківські активи.";
  }
  showModal();
