...
const openModal = (num) => {
  ...
  switch (num) {
    ...
    case 5:
      ...
      myAnswer =
        "Креативності в моїй біографії аж забагато. Працював копірайтером, контент-менеджером, креативним-директором. Більше подробиць - у резюме.<br/> Відзначу лише, що для мене креатив - це створення ідеї, а не картинки.<br/> Я - не дизайнер, не стиліст і ніколи не любив малювати))";
      break;
    case 6:
      requirement = "Вміння працювати в команді";
      myAnswer =
        "Всі кажуть, зі мною комфортно працювати. Я не педант, але завжди мислю раціонально. Витримую дедлайни, поважаю конструктивну критику. Вмію йти за лідером, можу вести за собою. <br/>Я завжди на зв'язку та готовий швидко підключитися до нової задачі.";
      break;
    case 7:
      requirement =
